...
if (!$_SESSION['user']) {
    ...
    <head>
        ...
        <link rel="stylesheet" href="/css/adminPageMenu.css" type="text/css" media="all" />
        <title>Cinema</title>
    </head>
    ...
    <div class="containerOfAllSite">
        ...
        <div class="contentDiv" style="display: flex; justify-content: center;">
            ...
            <div class="printContainer">
                ...
                <div class="showMovies">
                    ...
                    <div class="printMovieMap" style="align-content: center">
                        <?php
                        $counter = 1;
                        for ($sec = 1;
                        $sec <= $sections;
