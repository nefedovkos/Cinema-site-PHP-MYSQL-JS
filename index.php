                ...
                <div class="moviesAlign">
                    ...
                    ?>
                        ...
                        foreach ($gateMovies as $gateMovie){
                            if($gateMovie['movie_id'] == $movie['id']) {


                                array_push($tempMoviesToShow , ($movie['id']));
                        ...
                        for ($i = 0; $i < count($tempMoviesToShow); $i++) {
                            $foundSame = false;
                            for ($j = 0; $j <= count($moviesToShow); $j++) {
                                if ($tempMoviesToShow[$i] == $moviesToShow[$j]) {
                                    $foundSame = true;
                                }

                            }
                            if (!$foundSame) {
                                array_push($moviesToShow, ($tempMoviesToShow[$i]));
                                ?>
                                <div class="movieContainer" >
                                    <div class="movieCard">
                                        ...
                                        <div align="center" class="contentBox">
                                            ...
                                            <form action="ticketsNoGate.php" method="post" class="movieForm">
