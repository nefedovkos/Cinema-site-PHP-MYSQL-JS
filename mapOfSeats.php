...
if (!$_SESSION['user']) {
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Oswald:200,300,400,500|Roboto+Condensed:300,300i,400,400i,700,700i"
              rel="stylesheet">
        ...
        <link rel="stylesheet" href="/css/mapOfSeatsSubPageMenu.css" type="text/css" media="all"/>
        <title>Cinema</title>
    </head>
